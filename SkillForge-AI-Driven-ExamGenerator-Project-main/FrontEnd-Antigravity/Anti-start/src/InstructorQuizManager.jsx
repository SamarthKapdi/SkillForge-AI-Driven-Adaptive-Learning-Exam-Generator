    ...
    const handleAiGenerate = async () => {
        ...
        try {
            ...
            const updatedQuizData = {
                ...
                questionType: computedType // ⚡ FIXED: classified correctly
            };
            setQuizData(updatedQuizData);
            console.log("💾 Quiz data synced with AI params:", updatedQuizData);

            setMessage({ type: 'success', text: `AI generated ${genQuestions.length} questions successfully! Review them below.` });
            ...
            setMessage({ type: 'error', text: `AI Generation Error: ${errorMessage}` });
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} md={6}>
                                            <TextField
                                                ...
                                                onChange={(e) => setAiParams({ ...aiParams, questionType: e.target.value })}
                                            >
